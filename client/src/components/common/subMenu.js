        ...
        switch (this.state.type) {
            ...
            case 1:
                return (<ul>
                    ...
                    <li className={this.menuClassNames(5)} onMouseEnter={() => this.menuHandleHover(5)} onMouseLeave={this.menuHandleBlur} onClick={() => this.menuHandleClick(5)}> <Link to="/" > تغیر مقادیر </Link></li>
                    ...
                    <li className={this.menuClassNames(7)} onMouseEnter={() => this.menuHandleHover(7)} onMouseLeave={this.menuHandleBlur} onClick={() => this.menuHandleClick(7)}> <Link to="/" > تمدید مدت قرارداد </Link></li>
                 ...
                 case 2:
                    return (<ul>
                       {/*  <li className={this.menuClassNames(1)}  onClick={() => this.menuHandleClick(1)}> <Link to="/wbs" > ساختار شکست</Link></li>
                        <li className={this.menuClassNames(2)}  onClick={() => this.menuHandleClick(2)}> <Link to="/town" > شناسنامه شهرکها </Link></li>
                        <li className={this.menuClassNames(3)}  onClick={() => this.menuHandleClick(3)}> <Link to="/project" > شناسنامه پروژه </Link></li>
                        <li className={this.menuClassNames(4)}  onClick={() => this.menuHandleClick(4)}> <Link to="/contract" > شناسنامه قرارداد </Link></li>
                        <li className={this.menuClassNames(5)}  onClick={() => this.menuHandleClick(5)}> <Link to="/company" > تغیر مقادیر </Link></li>
                        <li className={this.menuClassNames(6)}  onClick={() => this.menuHandleClick(6)}> <Link to="/company" > ابلاغ افزایش قرارداد </Link></li>
                        <li className={this.menuClassNames(7)}  onClick={() => this.menuHandleClick(7)}> <Link to="/company" > تمدید مدت قرارداد </Link></li>
                        <li className={this.menuClassNames(8)}  onClick={() => this.menuHandleClick(8)}> <Link to="/company" > چرخه پیمان </Link></li>
                        <li className={this.menuClassNames(9)}  onClick={() => this.menuHandleClick(9)}> <Link to="/test" > بیمه </Link></li> */}
                    </ul>)
            default:
                return (<div></div>)
        }
