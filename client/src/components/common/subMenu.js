        ...
        switch (this.state.type) {
            ...
            case 1:
                return (<ul>
                    ...
                    <li className={this.menuClassNames(2)} onMouseEnter={() => this.menuHandleHover(2)} onMouseLeave={this.menuHandleBlur} onClick={() => this.menuHandleClick(2)}> <Link to="/company" > شناسنامه شهرکها </Link></li>
                    ...
                    <li className={this.menuClassNames(4)} onMouseEnter={() => this.menuHandleHover(4)} onMouseLeave={this.menuHandleBlur} onClick={() => this.menuHandleClick(4)}> <Link to="/company" > شناسنامه قرارداد </Link></li>
                    ...
                    <li className={this.menuClassNames(7)} onMouseEnter={() => this.menuHandleHover(7)} onMouseLeave={this.menuHandleBlur} onClick={() => this.menuHandleClick(7)}> <Link to="/company" > تمدید مدت قرارداد </Link></li>
                    <li className={this.menuClassNames(8)} onMouseEnter={() => this.menuHandleHover(8)} onMouseLeave={this.menuHandleBlur} onClick={() => this.menuHandleClick(8)}> <Link to="/company" > چرخه پیمان </Link></li>
                    <li className={this.menuClassNames(9)} onMouseEnter={() => this.menuHandleHover(9)} onMouseLeave={this.menuHandleBlur} onClick={() => this.menuHandleClick(9)}> <Link to="/test" > بیمه </Link></li>
                </ul>)
            default:
                return (<div></div>)
        }
