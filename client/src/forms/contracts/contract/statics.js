...
export const columns = [
    ...
    { selected: true, dataIndex: 'contract_no', key: 'contract_no', title: 'شماره پیمان' },
    ...
    { selected:true,dataIndex: 'contract_date',key: 'contract_date', title: 'تاریخ پیمان', render: function (text) { return text&&moment.isMoment(text)?text.format('jYYYY/jMM/jDD') :''}},  
    //  { dataIndex: 'announcement_date',key: 'announcement_date', title: 'تاریخ ابلاغ پیمان' }, 
