...
export const columns = [
  { dataIndex: 'id',key: 'id', title: 'شناسه ' }, 
   ...
   { dataIndex: 'letter_date',key: 'letter_date', title: 'تاریخ نامه ابلاغ تمدید' , render: function (text) { return text?text.format('jYYYY/jMM/jDD'):'' }}, 
   { dataIndex: 'TotalDuration',key: 'TotalDuration', title: 'جمع مدت اولیه پیمان به اضافه مدت تمدیدهای قبل' }, 
   { dataIndex: 'duration',key: 'duration', title: 'مدت تمدید شده ابلاغ فعلی' }, 
   { dataIndex: 'end_date',key: 'end_date', title: 'تاریخ پایان ' , render: function (text) { return text?text.format('jYYYY/jMM/jDD') :''}}, 
   { dataIndex: 'Announcement_date',key: 'Announcement_date', title: 'تاریخ پایان ابلاغ فعلی' , render: function (text) { return text?text.format('jYYYY/jMM/jDD'):'' }},
