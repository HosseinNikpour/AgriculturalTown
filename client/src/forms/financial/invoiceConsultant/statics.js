...
//  { dataIndex: 'start_date',key: 'start_date', title: 'تاریخ شروع دوره کارکرد' , render: function (text) { return  text&&moment.isMoment(text)?text.format('jYYYY/jMM/jDD'):'' } }, 
 ...
 { dataIndex: 'consultant_price',key: 'consultant_price', title: 'مبلغ ارائه شده مشاور', render: function (text) { return  text?text.toLocaleString():0 }}, 
  { dataIndex: 'manager_price',key: 'manager_price', title: 'مبلغ تایید مدیر طرح', render: function (text) { return  text?text.toLocaleString():0 } }, 
  { dataIndex: 'period_price',key: 'period_price', title: 'کارکرد دوره', render: function (text) { return  text?text.toLocaleString():0 } }, 
