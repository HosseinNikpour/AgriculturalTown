...
export const columns = [
 ...
 // { dataIndex: 'prev_approve_id',key: 'prev_approve_id', title: 'شماره آخرین صورت وضعیت تایید شده دفتر فنی' }, 
  //{ dataIndex: 'prev_id',key: 'prev_id', title: 'شماره آخرین صورت وضعیت پرداخت شده مالی' }, 
  //{ dataIndex: 'prev_approve_price',key: 'prev_approve_price', title: 'مبلغ آخرین صورت وضعیت تایید شده دفتر فنی', render: function (text) { return  text?parseInt(text).toLocaleString():0 }  }, 
