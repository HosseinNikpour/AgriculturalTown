...
class PayInvoiceContractor extends Component {
    ...
    fetchData() {
        Promise.all([getAllItem(storeIndex), getAllItem('contract/vw'), getAllItem('BaseInfo/vw'), getAllItem('invoiceContractorApprove') 
         , getItem("invoiceContractorPay", 'PermissionStructure')]).then((response) => {
                            ...
                            <div className="card">
                                ...
                                <form>
                                        ...
                                        <div className="row">
                                            <div className="col-4">
                                                <div className="form-group">
                                                    <label htmlFor="prev_approve_id" className="">شماره آخرین صورت وضعیت تایید شده دفتر فنی</label>
                                                    <label className="form-control">{this.state.obj.prev_approve_id}</label>
                                                </div>
                                            </div>
                                            <div className="col-4">
                                                <div className="form-group">
                                                    <label htmlFor="prev_approve_price" className="">مبلغ آخرین صورت وضعیت تایید شده دفتر فنی</label>
