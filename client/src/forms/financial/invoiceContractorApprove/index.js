...
class PayInvoiceContractor extends Component {
    ...
    fetchData() {
        Promise.all([getAllItem(storeIndex), getAllItem('contract/vw'), getAllItem('BaseInfo/vw'), getAllItem('invoiceContractor')
            , getItem("invoiceContractorApprove", 'PermissionStructure')]).then((response) => {
                ...
                this.setState({
                    ...
                    isFetching: false, rows: data, contracts, invioces, invoice_no, TypePay,
                                ...
                                <div className="card-body">
                                    <form>
                                        ...
                                        <div className="row">
                                            <div className="col-4">
                                                <div className="form-group">
                                                    <label htmlFor="prev_price" className="">مبلغ آخرین صورت وضعیت تایید شده دفتر فنی کارفرما</label>
                                                    <label className="form-control">{this.state.obj.prev_price ? this.state.obj.prev_price.toLocaleString() : 0}</label>
                                                </div>
                                            </div>
                                            <div className="col-4">
                                                <div className="form-group">
                                                    <label htmlFor="prev_id" className="">شماره آخرین صورت وضعیت تایید شده دفتر فنی کارفرما</label>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-4">
                                                <div className="form-group">
                                                    ...
                                                    <label htmlFor="letter_date_employer" className="">تاریخ  تایید دفتر فنی کارفرما</label>
