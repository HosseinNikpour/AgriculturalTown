...
// { dataIndex: 'letter_date_manager',key: 'letter_date_manager', title: 'تاریخ نامه معاون فنی و اجرایی' , render: function (text) { return  text&&moment.isMoment(text)?text.format('jYYYY/jMM/jDD'):'' } },
//{ dataIndex: 'letter_no_manager', key: 'letter_no_manager', title: 'شماره نامه معاون فنی و اجرایی' },
