...
class notif_zamin extends Component {
    constructor(props) {
        super(props);
    ...
    fetchData() {
        ...
        let columns = [
            ...
            { dataIndex: 'diff', key: 'diff', title: 'اختلاف', width: '120px' },
                        ...
                        <div className="col-12">
                            <div className="card">
                                <div className="card-header">
                                    <div className="row">
                                        <div className="col">
                                        پیمان های ابلاغ شده ای که تحویل زمین به پیمانکار صورت نپذیرفته و یا  فاقد سند تحویل زمین می باشند
                                        </div>
