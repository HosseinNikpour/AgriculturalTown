...
class ReportWeb1 extends Component {
    ...
    fetchData() {
        let columns = [
            ...
            { dataIndex: 'file_dxf',key: 'file_dxf', title: ' فایل کروکی DXF شهرک',width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            { dataIndex: 'file_kmz',key: 'file_kmz', title: 'فایل کروکی KMZ شهرک' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            { dataIndex: 'file_plan',key: 'file_plan', title: 'فایل پی دی اف پلان شهرک',width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} }, 
            ...
            { dataIndex: 'in_file_contract',key: 'in_file_contract', title: 'قرارداد بیمه',width:'120px' ,render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            { dataIndex: 'in_app_file_contract',key: 'in_app_file_contract', title: 'الحاقیه بیمه' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            { dataIndex: 'td_file_record',key: 'td_file_record', title: 'صورتجلسه تحویل موقت' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} }, 
            { dataIndex: 'file_defect',key: 'file_defect', title: 'نواقص تحویل موقت',width:'120px' ,render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} }, 
            ...
            { dataIndex: 'delivery_file_record',key: 'delivery_file_record', title: 'صورتجلسه تحویل قطعی',width:'120px' ,render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            { dataIndex: 'inv_file_letter_manager',key: 'inv_file_letter_manager', title: 'نامه تایید صورت وضعیت توسط مدیر طرح' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} }, 
            ...
            { dataIndex: 'file_letter_employer',key: 'file_letter_employer', title: 'نامه تایید صورت وضعیت توسط معاون فنی' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
      
            { dataIndex: 'file_invoice_pay',key: 'file_invoice_pay', title: 'نامه تایید پرداخت توسط واحد مالی' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
