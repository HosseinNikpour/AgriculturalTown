...
class ReportWeb1 extends Component {
    ...
    fetchData() {
        let columns = [
            ...
            { dataIndex: 'ag_file_agreement',key: 'ag_file_agreement', title: 'موافقتنامه',width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} }, 
            { dataIndex: 'ag_file_announcement',key: 'ag_file_announcement', title: 'نامه ابلاغ ' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} }, 
            { dataIndex: 'file_land_delivery',key: 'file_land_delivery', title: 'صورتجلسه تحویل زمین',width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            { dataIndex: 'ag_file_record',key: 'ag_file_record', title: 'بارگذاری صورتجلسه تصویب طرح',width:'120px' ,render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            ...
            { dataIndex: 'letter_number_25percent',key: 'letter_number_25percent', title: 'نامه ابلاغ 25 درصد',width:'120px' ,render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} }, 
            ...
            { dataIndex: 'PC_file_record',key: 'PC_file_record', title: 'بارگذاری صورتجلسه',width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} }, 
            ...
            { dataIndex: 'td_file_signification',key: 'td_file_signification', title: 'سند ابلاغ صورتجلسه',width:'120px' ,render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} }, 
            ...
            { dataIndex: 'delivery_file_free',key: 'delivery_file_free', title: 'بارگذاری نامه آزادسازی به واحد مالی' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} }, 
            ...
            { dataIndex: 'd_file_signification',key: 'd_file_signification', title: 'سند ابلاغ صورتجلسه' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} }, 
            { dataIndex: 'file_free',key: 'file_free', title: 'بارگذاری نامه آزادسازی به واحد مالی',width:'120px' ,render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} }, 
            ...
            { dataIndex: 'inv_con_file_letter_manager',key: 'inv_con_file_letter_manager', title: 'بارگذاری نامه مدیر طرح' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            { dataIndex: 'inv_con_file_invoice',key: 'inv_con_file_invoice', title: 'روکش صورت وضعیت' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            ...
            { dataIndex: 'file_letter_manager',key: 'file_letter_manager', title: 'بارگذاری سند نامه مدیر طرح' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            { dataIndex: 'file_letter_employer_approve',key: 'file_letter_employer_Approve', title: 'بارگذاری نامه دفتر فنی کارفرما به مالی' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            { dataIndex: 'file_letter_manager_approve',key: 'file_letter_manager_Approve', title: 'بارگذاری سند نامه مدیر طرح' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            ...
            { dataIndex: 'file_invoice_con_pay',key: 'file_invoice_con_pay', title: 'بارگذاری سند مالی' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            { dataIndex: 'file_invite',key: 'file_invite', title: 'بارگذاری دعوتنامه' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            { dataIndex: 'file_record',key: 'file_record', title: 'بارگذاری صورتجلسه' ,width:'120px',render :function(text){return text?<a target="_blank" href={text}>مشاهده </a>:''} },
            ];
